...
const Edit_Report = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axiosInstance
      .put(`/report/request/${id}`, faultreport)
      .then((result) => {
        if (result.data.Status) {
                                ...
                                <div className="row justify-content-center">
                                  <div className="col-md-9">
                                    <div className="p-3 rounded">
                                      <h3 className="text-secondary text-center mb-4">
                                        Edit Request
                                      </h3>
                                      <form
                                        className="row g-3"
                                        ...
                                        <div className="form-control p-4">
                                          ...
                                          <div className="col-12 mt-3">
                                            ...
                                            >
                                              ...
                                              <option value="Automatic/Motorised Gates/Roller Shutters">
